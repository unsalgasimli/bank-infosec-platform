...
try {
  ...
  await page.screenshot({path:'outputs/wind-garden/refined-desktop.png'});
  ...
  await mobile.screenshot({path:'outputs/wind-garden/refined-mobile.png',fullPage:true});
...
finally{fs.writeFileSync('outputs/wind-garden/refined-chapters-results.json',JSON.stringify(results,null,2));console.log(JSON.stringify(results,null,2));await browser.close();}
