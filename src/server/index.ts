...
app.post('/api/threats/:id/catalog-controls', ThreatModelsController.catalogControl);
app.post('/api/threat-models/:id/control-threat-mappings', ThreatModelsController.mapControlThreat);
app.get('/api/threat-governance-policy', ThreatModelsController.governancePolicy);
app.post('/api/threat-models/:id/release-authorization/consume', ThreatModelsController.consumeReleaseAuthorization);
app.put('/api/threat-governance-policy', ThreatModelsController.updateGovernancePolicy);
app.post('/api/threat-compliance-requirements', ThreatModelsController.compliance);
app.get('/api/threat-models/:id/governance', ThreatModelsController.governanceDetail);
app.get('/api/threat-models/:id/access-grants', ThreatModelsController.grants);
app.get('/api/threat-models/:id/lifecycle', ThreatModelsController.lifecycle);
app.get('/api/threat-models/:id/evidence/:evidenceId/download', ThreatModelsController.downloadEvidence);
app.post('/api/threat-models/:id/compliance-mappings/replace', ThreatModelsController.replaceCompliance);
app.post('/api/threat-models/:id/exceptions/:exceptionId/escalation-review', ThreatModelsController.escalateException);
app.post('/api/threat-models/:id/retirement-requests', ThreatModelsController.retire);
app.post('/api/threat-models/:id/retirement-requests/:requestId/decision', ThreatModelsController.decideRetirement);
app.post('/api/threat-models/:id/retention-events', ThreatModelsController.retain);
app.post('/api/threat-models/:id/access-grants', ThreatModelsController.grant);
app.post('/api/threat-models/:id/access-grants/:grantId/revoke', ThreatModelsController.revokeGrant);
app.post('/api/threat-compliance-requirements/:id/decision', ThreatModelsController.decideCompliance);
app.get('/api/threat-models/:id/analysis', ThreatModelsController.analysis);
app.post('/api/threat-models/:id/analysis/suggest', ThreatModelsController.suggestThreats);
app.post('/api/threat-models/:id/analysis/import', ThreatModelsController.importSuggestion);
app.post('/api/threat-models/:id/analysis/suggestions/:suggestionId/disposition', ThreatModelsController.disposeSuggestion);
app.post('/api/threat-models/:id/analysis/cases', ThreatModelsController.attackCase);
app.get('/api/threat-models/:id/finding-links', ThreatModelsController.findingLinks);
app.post('/api/threat-models/:id/finding-links', ThreatModelsController.linkFinding);
app.post('/api/threat-models/:id/finding-links/:linkId/assessment', ThreatModelsController.assessFinding);
app.post('/api/threat-models/:id/emergencies', ThreatModelsController.requestEmergency);
app.post('/api/threat-models/:id/emergencies/:emergencyId/decision', ThreatModelsController.decideEmergency);
app.post('/api/threat-models/:id/emergencies/:emergencyId/deployment', ThreatModelsController.deployEmergency);
app.post('/api/threat-models/:id/emergencies/:emergencyId/review', ThreatModelsController.reviewEmergency);
app.post('/api/threat-models/:id/emergencies/:emergencyId/close', ThreatModelsController.closeEmergency);
app.post('/api/threat-models/:id/requirement-controls', ThreatModelsController.linkRequirementControl);
app.post('/api/threat-models/:id/scope', ThreatModelsController.updateScope);
app.post('/api/threat-models/:id/security-requirements', ThreatModelsController.requirement);
app.post('/api/threat-models/:id/data-objects', ThreatModelsController.dataObject);
app.post('/api/threats/:id/transition', ThreatModelsController.transitionThreat);
app.post('/api/threats/:id/content', ThreatModelsController.updateThreat);
app.post('/api/threat-models/:id/architecture/:kind/:entityId', ThreatModelsController.editArchitecture);
app.get('/api/threats/:id/lineage', ThreatModelsController.threatLineage);
app.get('/api/threat-models/:id/revisions/:revisionId/export', ThreatModelsController.exportSnapshot);
